...
typedef enum { DirectionalEmitter, RadialEmitter, SphereEmitter, DiscEmitter , RingEmitter } EmitterType;
...
public:
    ...
    void setParticleRadiusVariance(const float rv) { particleRadiusVariance = rv; }
    ...
    void setParticleColor(ofColor color) { particleColor = color; }
    void setRingEmmiterHeight(float height)   { ringEmmiterHeight = height; }
	void update();
    ...
    float ringEmmiterHeight;
	float particleRadius;
    float particleRadiusVariance;
